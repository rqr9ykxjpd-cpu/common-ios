...
struct SampleProductService: ProductService {
    ...
    func deleteMessage(_ messageID: UUID) async throws { await store.deleteMessage(messageID) }
    func editMessage(_ messageID: UUID, body: String) async throws { await store.editMessage(messageID, body: body) }
