-- Referans listedeki rozetlerin tamamı (küfürlü tek rozet hariç). İstemcideki
-- `PostKind` ile birebir aynı liste; 20260914070000'in üstüne altı rozet.
...
alter table public.posts add constraint posts_kind_check
  check (kind in (
    ...
    'kgb_history', 'ataturk', 'aga_beee', 'bele', 'ahraz'
  ));
