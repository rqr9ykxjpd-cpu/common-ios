...
enum LegalTexts {
    ...
    static let kosullar: [LegalBlock] = [
        ...
        .paragraf("Common'ın temel özellikleri ücretsizdir. Common Plus ve Common Pro, isteğe bağlı haftalık aboneliklerdir; abone olmadan da uygulamayı kullanmaya devam edebilirsin."),
