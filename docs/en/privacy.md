...
**When you create an account:** your email address (provided to us when you
...
We do **not** read your location from your device. Where you appear on campus
is only the place you pick yourself from a list, and it clears automatically
when the time you chose runs out.
...
Under Turkish Personal Data Protection Law No. 6698 (KVKK) you have the right
to learn which of your data is processed, to ask for it to be corrected or
deleted, and to object to its processing. You can change your profile at any
time from inside the app and delete your account at any time. For anything
else, write to us at the address below.

## Changes

If we update this document we will change the date at the top, and we will
notify you in the app if the change is significant.

## Contact

**Email:** 220207018@yalova.edu.tr

We respond to reports and data requests within 24 hours.
